        ...
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center mb-10">
                <div className="sm:flex-auto">
                    ...
                    <p className="mt-2 text-sm text-gray-700">A detailed view of this patient.</p>
                </div>
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <span className="block w-full rounded-md border border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm sm:text-sm sm:leading-6">
                                        Hima
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-5">
                                ...
                                <div className="mt-2">
                                    <span className="block w-full rounded-md border border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm sm:text-sm sm:leading-6">
                                        123 Main St dsfasdf safsdfqwer wfwef
                                    </span>
                                </div>
                            </div>
                            <div className="sm:col-span-1">
