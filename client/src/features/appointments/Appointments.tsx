    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            <PageHeaderWithButton
                title={"Appointments"}
                description={"A list of all the appointments you have including the name of the patient, phone number, day and time."}
            ...
            {showModal && (
                <AddAppointmentModal onCloseModal={() => setShowModal(false)}/>
            )}
