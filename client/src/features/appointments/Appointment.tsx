...
const Appointment = () => {
    ...
    const handleCancelAppointment = async () => {
        fireModal("Are you sure you want to cancel this appointment?", () => cancelAppointmentMutate(appointment._id));
    };
        ...
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 border-t border-gray-100">
                <dl className="divide-y divide-gray-100">
                    ...
                    <EditableField label={"Patient Name"} value={appointment.patient.fullName} isEditable={false}/>
                    <EditableField label={"Status"} value={toProperCase(appointment.status)} isEditable={false}/>
